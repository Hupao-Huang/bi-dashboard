...
var permissionSeeds = []permissionSeed{
	...
	{Code: "customer.comment:edit", Name: "客服-评论改名/删除(仅管理员)", Type: "action"},
	{Code: "customer.service_score:view", Name: "客服-服务分管理", Type: "page"},
	...
	{Code: "supply_chain.sales_daily_report:edit", Name: "供应链-销售日报-改渠道映射", Type: "field"},
...
var roleDefaultPermissions = map[string][]string{
	"management": {
		...
		"supply_chain:view", "supply_chain.plan_dashboard:view", "supply_chain.inventory_warning:view", "supply_chain.logistics_analysis:view", "supply_chain.daily_alerts:view", "supply_chain.monthly_billing:view", "supply_chain.qc_alert:view", "supply_chain.sales_daily_report:view", "supply_chain.sales_daily_report:edit",
