...
export const menuDefinitions: MenuDefinition[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/finance/voucher', icon: <SnippetsOutlined />, label: '凭证查询', permission: 'finance.voucher:view' },
    ],
  },
  {
    key: '/customer',
...
export const pageTitleMap: Record<string, string> = {
  ...
  '/social/xiaohongshu': '小红书千帆',
  '/social/xiaohongshu-chengfeng': '小红书乘风',
  '/offline': '线下部门',
...
export const routePermissions: Array<{ path: string; permission: string }> = [
  ...
  { path: '/finance/voucher', permission: 'finance.voucher:view' },
