...
import { Card, Table, Tag, Select, Input, DatePicker, Row, Col, Statistic, Button, Modal, Typography, Badge, Tooltip, message } from 'antd';
import {
...
const ExpenseControl: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* 单据详情弹窗 — 抽到共享组件 HesiFlowDetailModal, 跟合思机器人(system/HesiBot)共用一套 */}
      {/* 改一处两边同步, 不会再出现一边升级一边漏 (跑哥要求"这两个一直保持一致") */}
      <HesiFlowDetailModal
